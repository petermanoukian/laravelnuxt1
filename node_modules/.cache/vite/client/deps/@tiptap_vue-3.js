...
import { defineComponent, ref, onMounted, onBeforeUnmount, h, markRaw, customRef, getCurrentInstance, watchEffect, nextTick, unref, shallowRef, reactive, render as render2, provide } from "vue";
...
var VueRenderer = class {
  ...
  renderComponent() {
    ...
    if (typeof document !== "undefined" && this.el) {
      render2(vNode, this.el);
    }
    const destroy = () => {
      if (this.el) {
        render2(null, this.el);
      }
      this.el = null;
      vNode = null;
    };
