...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderComponent } from 'file://C:/My-Documents/build4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-xxl py-1" }, _attrs))}><div class="container mt-4"><h1 class="text-center mb-1 wow fadeInUp" data-wow-delay="0.1s">Sub Categories of ${ssrInterpolate(cat.value.name)}</h1><div class="row g-4">`);
      if (cat.value) {
      ...
      _push(`</div></div><div class="container mt-4"><h1 class="text-center mb-1 wow fadeInUp" data-wow-delay="0.1s">SubCategories</h1><div class="row g-4 mt-4 mb-4 fullwidth margintopbottom8" style="${ssrRenderStyle({ "width": "97%", "clear": "both", "margin": "9px", "pading": "9px" })}"><p> Subcategoriess ${ssrInterpolate(unref(subcats))}</p></div><hr class="hr1">`);
      if (unref(subcats) && unref(subcats).length > 0) {
        _push(`<div class="row g-4 mt-4">`);
        ...
        _push(`<div class="row g-4 mt-4 fullwidth margintopbottom8"> No subcategories were found </div>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/subcat/viewsubcatbycatid/[catid].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_catid_-maoBrpqh.mjs.map
