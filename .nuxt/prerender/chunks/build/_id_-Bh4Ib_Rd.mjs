...
import { ref, onServerPrefetch, withAsyncContext, mergeProps, withCtx, createTextVNode, toDisplayString, unref, useSSRContext } from 'file://C:/My-Documents/build4/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList } from 'file://C:/My-Documents/build4/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    onServerPrefetch(async () => {
      console.log("onServerPrefetch is running...");
      await fetchProd();
    });
    if (prod.value) {
...
//# sourceMappingURL=_id_-Bh4Ib_Rd.mjs.map
