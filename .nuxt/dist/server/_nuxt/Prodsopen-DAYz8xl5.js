...
import { mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext, watch, unref } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.prod.des !== "null" && $props.prod.des !== "NULL" && $props.prod.des !== "") {
    _push(`<div class="formatted-result">${$props.prod.des ?? ""}</div>`);
  } else {
    _push(`<!---->`);
  }
...
//# sourceMappingURL=Prodsopen-DAYz8xl5.js.map
